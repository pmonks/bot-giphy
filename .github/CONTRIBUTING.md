...
doesn't impede contributions to the project.
...
**By submitting a contribution to this project you agree to the above statements.**

# Contributing Issues

## Prerequisites

* [ ] Have you [searched for duplicates](https://github.com/pmonks/bot-giphy/issues?utf8=%E2%9C%93&q=)?  A simple search for exception error messages or a summary of the unexpected behaviour should suffice.
* [ ] Are you running the [latest release of the Clojure bot](https://github.com/pmonks/bot-giphy/commits/master)?

## Raising an Issue
* Create your issue [here](https://github.com/pmonks/bot-giphy/issues/new).
 ...
 * For documentation contributions, follow the general structure, language, and tone of the [existing docs](https://github.com/pmonks/bot-giphy/wiki).
 ...
 * If necessary (e.g. due to 3rd party dependency licensing requirements), update the [NOTICE file](https://github.com/pmonks/bot-giphy/blob/master/NOTICE) with any new attribution or other notices
