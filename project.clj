...
(defproject org.finos.symphony/bot-giphy "0.1.0-SNAPSHOT"
  :description      "A bot that adds a /giphy command to Symphony chat."
  :url              "https://github.com/pmonks/bot-giphy"
  ...
  :dependencies     [
                      ...
                      [clj-time                         "0.15.2"]
                      [clj-http                         "3.10.1" :exclusions [org.clojure/clojure]]
                      [cheshire                         "5.10.0"]
  ...
  :profiles         {:dev {:dependencies [[midje         "1.9.9"]]
                           :plugins      [[lein-midje    "3.2.1"]
                                          [lein-licenses "0.2.2"]]}
                     :uberjar {:aot          :all
                               :uberjar-name "bot-giphy-standalone.jar"}}
  :main             bot-giphy.main)
